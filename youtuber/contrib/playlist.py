...
from youtuber import extract, request, YouTube
from youtuber.helpers import cache, DeferredGeneratorList, install_proxy, uniqueify
...
class Playlist(Sequence):
    ...
    def last_updated(self) -> Optional[date]:
        ...
        fact that this value is returned as a string, youtuber does a best-effort parsing
