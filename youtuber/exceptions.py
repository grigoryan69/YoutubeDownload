...
class youtuberError(Exception):
    """Base youtuber exception that all others inherit.
...
class MaxRetriesExceeded(youtuberError):
    """Maximum number of retries exceeded."""


class HTMLParseError(youtuberError):
    """HTML could not be parsed"""


class ExtractError(youtuberError):
...
class VideoUnavailable(youtuberError):
