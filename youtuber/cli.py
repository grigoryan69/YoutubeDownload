...
from youtuber import __version__
from youtuber import CaptionQuery, Playlist, Stream, YouTube
from youtuber.helpers import safe_filename, setup_logger
...
def main():
    ...
    if args.verbose:
        ...
        logger.debug(f'youtuber version: {__version__}')
    ...
    if "/playlist" in args.url:
        ...
        for youtube_video in playlist.videos:
            ...
            except exceptions.youtuberError as e:
...
def _parse_args(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "The list option causes youtuber cli to return a list of streams "
