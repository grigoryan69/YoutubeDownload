...
import linker.chrome as chm
import linker.electron as ele
import linker.edge as edge
# import linker.firefox as ffx      TODO
# import linker.safari as saf       TODO
    ...
    if mode in [None, False]:
        ...
        if path is not None:
            ...
            raise EnvironmentError(
                "Can't find %s installation" % browser_module.name)
    else:
